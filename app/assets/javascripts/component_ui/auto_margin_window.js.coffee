...
@AutoMarginWindowUI = flight.component ->
  @after 'initialize', ->
    gutter = GUTTER
    gutter_2x = GUTTER * 2
    gutter_3x = GUTTER * 3
    ...
    @$node.resize ->
      ...
      margin_info_h  = $('#margin_info').height() + BORDER_WIDTH
      ...
      trades_h = window_h - navbar_h - markets_h - margin_info_h - gutter_3x - BORDER_WIDTH*2
