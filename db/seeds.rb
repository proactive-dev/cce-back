ADMIN_EMAIL = 'admin@apolloit.biz'
...
if Rails.env == 'development'
  ...
  foo = Identity.create(email: 'foo@apolloit.biz', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'bar@apolloit.biz', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
