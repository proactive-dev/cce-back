ADMIN_EMAIL = 'admin@ngo-settlement.com'
...
if Rails.env == 'development'
  ...
  foo = Identity.create(email: 'foo@ngo-settlement.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'bar@ngo-settlement.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
